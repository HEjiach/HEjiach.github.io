...
$.ajax({
  ...
  data: {
    key: 'QXQBZ-RNRWU-BLEVI-GYPI6-UJOB3-JLFWTQXQBZ-RNRWU-BLEVI-GYPI6-UJOB3-JLFWT',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function createtime() {
  ...
  var start = new Date("2001-10-21T00:00:00Z"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  // 网站诞生时间
  var grt = new Date("2024-09-16T00:00:00Z");
